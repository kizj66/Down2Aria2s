...
const CRX_OUTDIR = "dist";
const CRX_CONFIRM_OUTDIR = "_dist_confirm";
const CRX_BACKGROUND_OUTDIR = "_dist_background";
...
const contentOutDir = path.resolve(process.cwd(), CRX_CONFIRM_OUTDIR);
